...
if !haskey(ENV, "JULIA_PKGEVAL")
  ...
  for p in 0:2
      basis_sympypythoncall = GaussRadauLeft(p, SymPyPythonCall.Sym)
  ...
  @test_throws ArgumentError GaussRadauLeft(3, SymPyPythonCall.Sym)

  for p in 0:2
      basis_sympypythoncall = GaussRadauRight(p, SymPyPythonCall.Sym)
  ...
  @test_throws ArgumentError GaussRadauRight(3, SymPyPythonCall.Sym)
  ...
  interpolation_matrix([-1, 1], GaussRadauLeft(2, SymPyPythonCall.Sym))
  interpolation_matrix([-1, 1], GaussRadauRight(2, SymPyPythonCall.Sym))
end
